...
namespace SAF.Hardware.Controls
{
    ...
    /// </summary>
    public class LedControl : System.Windows.Forms.Control, ISupportInitialize
    {
        #region Nested Types
        /// <summary>
        ...
        public LedControl()
        {
            ...
            this.BackColor_1 = Color.Navy;
            this.BackColor_2 = Color.Navy;

            this.FadedColor = Color.Transparent;
            this.FocusedBorderColor = Color.Navy;
        ...
        private void DrawChars(Graphics g, float segmentWidth, float segmentInterval)
        {
            ...
            int totalElements = this.TotalCharCount;
            ...
            Color col2, Color colBorder, int nBorderWidth, bool bGradient, bool bDrawBorder)
        {
            ...
            if (bGradient)
            {
                br = new System.Drawing.Drawing2D.LinearGradientBrush(rect, col1, col2, 90, false);
            }
            else
            {
       ...
       // private int m_nCharacterNumber = 5;
        ...
        public int TotalCharCount
        {
            get
            {
                int subRectWidth = (int)(this.ClientRectangle.Height * WIDTHHEIGHTRATIO);
                return (this.Width - 3) / subRectWidth;
            }
