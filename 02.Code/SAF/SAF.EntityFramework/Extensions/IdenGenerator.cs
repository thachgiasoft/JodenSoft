...
namespace SAF.EntityFramework
{
    ...
    public static class IdenGenerator
    {
        ...
        /// <returns></returns>
        private static int NewIden(string connectionName, string groupName, int count, bool save, int startIden)
        {
        ...
        /// <param name="groupName"></param>
        /// <returns></returns>
        private static int NewIden(string connectionName, string groupName)
        {
