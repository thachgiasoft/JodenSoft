...
{
    public class Choice : DrawRhombus
    {
         public Choice()
            : this(0, 0, 1, 1)
        {
         ...
         public Choice(int x, int y, int width, int height)
    ...
    class ToolChoice : ToolDiagramBase
    {
        public ToolChoice()
        {
        ...
        public override void OnMouseUp(DrawArea drawArea, MouseEventArgs e)
        {
            ...
            var obj=new Choice(p.X, p.Y, 100, 50);
