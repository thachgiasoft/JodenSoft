...
{
    public class FlowLine : DrawLine
    {
        public FlowLine()
            : this(0, 0, 1, 0)
        {
        ...
        public FlowLine(int x1, int y1, int x2, int y2)
        ...
        public override GraphicsType Type
        {
            get
            {
                return GraphicsType.FlowLine;
            }
        }

        public override DrawObject Clone()
        {
            FlowLine drawLine = new FlowLine();
    ...
    class ToolFlowLine : ToolLine
    {
        ...
        public override void OnMouseDown(DrawArea drawArea, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            line = new FlowLine(p.X, p.Y, p.X + 1, p.Y);
