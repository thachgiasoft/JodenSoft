...
{
    public class Transition : DrawLine
    {
        public Transition()
            : this(0, 0, 1, 0)
        {
        ...
        public Transition(int x1, int y1, int x2, int y2)
            : base(x1, y1, x2, y2, false, true, ArrowType.Fill)
        {
        ...
        public override GraphicsType Type
        {
            get
            {
                return GraphicsType.Transition;
            }
        }
        ...
        {
            Transition drawLine = new Transition();
    ...
    class ToolTransition : ToolLine
    {
        public ToolTransition()
            : base(false, true, ArrowType.Fill)
        {
        }
        ...
        public override void OnMouseDown(DrawArea drawArea, System.Windows.Forms.MouseEventArgs e)
        {
            ...
            line = new Transition(p.X, p.Y, p.X + 1, p.Y);
