...
namespace SAF.Framework.Controls.Charts
{
    ...
    public class UndoManager
    {
        ...
        GraphicsCollection drawObjectList;
        ...
        public UndoManager(GraphicsCollection drawObjectList)
        {
        ...
        public void Undo()
        {
            ...
            // m_Execute the Command object's undo method
            command.Undo(drawObjectList);
        ...
        public void Redo()
        {
            ...
            // m_Execute the Command object
            command.Redo(drawObjectList);
