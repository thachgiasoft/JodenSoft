...
namespace SAF.Framework.Controls.Charts
{
    ...
    internal class CommandChangeState : Command
    {
        ...
        public CommandChangeState(GraphicsCollection graphicsList)
        {
        ...
        private void ReplaceObjects(GraphicsCollection graphicsList, List<DrawObject> list)
        {
        ...
        private void FillList(GraphicsCollection graphicsList, ref List<DrawObject> listToFill)
        {
