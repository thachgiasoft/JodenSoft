...
using SAF.Framework.Controls.TextEditor.Util;
...
//			((DefaultWorkbench)WorkbenchSingleton.Workbench).UpdateToolbars();
		...
		{
			new SAF.Framework.Controls.TextEditor.Actions.Delete().Execute(textArea);
		}
		
		public void SelectAll(object sender, EventArgs e)
		{
			new SAF.Framework.Controls.TextEditor.Actions.SelectWholeDocument().Execute(textArea);
		}
