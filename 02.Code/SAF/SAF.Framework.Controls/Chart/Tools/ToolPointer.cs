    ...
    class ToolPointer : Tool
    {
        ...
        public override void OnMouseDown(DrawArea drawArea, MouseEventArgs e)
        {
            ...
            foreach (DrawObject o in drawArea.Selection)
            {
                ...
                if (handleNumber > 0)
                {
                    ...
                    commandChangeState = new CommandChangeState(drawArea);
            ...
            {
                int n1 = drawArea.Count;
                DrawObject o = null;

                for (int i = 0; i < n1; i++)
                {
                    if (drawArea[i].HitTest(point) == 0)
                    {
                        o = drawArea[i];
                        break;
                    }
        ...
        public override void OnMouseMove(DrawArea drawArea, MouseEventArgs e)
        {
            ...
            if (e.Button == MouseButtons.None)
            {
                ...
                for (int i = 0; i < drawArea.Count; i++)
                {
                    ...
                    if (n > 0)
                    {
                        cursor = drawArea[i].GetHandleCursor(n);
                        break;
                    }
                }
        ...
        public override void OnMouseUp(DrawArea drawArea, MouseEventArgs e)
        {
            ...
            if (commandChangeState != null && wasMove)
            {
                ...
                commandChangeState.NewState(drawArea);
