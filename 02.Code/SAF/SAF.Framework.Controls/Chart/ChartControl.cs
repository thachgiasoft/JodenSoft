...
namespace SAF.Framework.Controls.Chart
{
    ...
    public partial class ChartControl : XtraUserControl
    {
        ...
        private void bbiRhombus_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            CommandRhombus();
        }
        ...
        private void CommandRhombus()
        {
            if (this.ActiveDrawArea != null)
                this.ActiveDrawArea.ActiveDrawTool = DrawToolType.Rhombus;
        }
        ...
        private void bbiLane_ItemClick(object sender, DevExpress.XtraBars.ItemClickEventArgs e)
        {
            if (this.ActiveDrawArea != null)
                this.ActiveDrawArea.ActiveDrawTool = DrawToolType.Lane;
        }
