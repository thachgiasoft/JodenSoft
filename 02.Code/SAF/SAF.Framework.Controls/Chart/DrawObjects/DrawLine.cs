...
namespace SAF.Framework.Controls.Chart
{
    ...
    //                        endY += 1;
    //                    AreaPath.AddLine(StartPoint.X, StartPoint.Y, endX, endY);
    ...
    //                catch (Exception ex)
    //                {
    //                    var message = string.Format("StartPoint.X:{0},  StartPoint.Y:{1}, EndPoint.X:{2}, EndPoint.Y:{3}", StartPoint.X, StartPoint.Y, EndPoint.X, EndPoint.Y);
    ...
    //    public override DiagramItem ToDiagramItem()
    //    {
    //        DiagramItem drawLine = new DiagramItem();
    //        FillDiagramItemFields(drawLine);
    //        return drawLine;
    //    }

    //    protected override void FillDiagramItemFields(DiagramItem item)
    //    {
    //        base.FillDiagramItemFields(item);
    //        item.iStartPointX = this.StartPoint.X;
    //        item.iStartPointY = this.StartPoint.Y;

    //        item.iEndPointX = this.EndPoint.X;
    //        item.iEndPointY = this.EndPoint.Y;

    //        item.iStartOffsetSizeWidth = this.StartOffsetSize.Width;
    //        item.iStartOffsetSizeHeight = this.StartOffsetSize.Height;

    //        item.iEndOffsetSizeWidth = this.EndOffsetSize.Width;
    //        item.iEndOffsetSizeHeight = this.EndOffsetSize.Height;

    //        item.uFromItemGuid = this.StartDrawObjectID;
    //        item.uToItemGuid = this.EndDrawObjectID;

    //        item.bIsDotLine = this.IsDotLine;
    //        item.bCanMove = this.CanMove;
    //        item.iArrowType = (int)this.ArrowType;
    //    }
